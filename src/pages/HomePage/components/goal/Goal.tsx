  ...
  return (
    <div className="goal">
      ...
      <div className="goal-detail">
        ...
        <p>
          Misi kami adalah membantu individu yang membutuhkan, dengan memberikan
          dukungan untuk melewati kesulitan dan menciptakan masa depan yang baik
          untuk semua.
        </p>
        <div className="points">
          <div className="point">
            ...
            <p>Memberikan bantuan kepada individu yang membutuhkan dukungan</p>
          </div>
          <div className="point">
            <span>
              <svg
            ...
            <p>
              Menyebarkan kesadaran akan isu-isu sosial dan kebutuhan mendesak
              di masyarakat
            </p>
          </div>
          <div className="point">
